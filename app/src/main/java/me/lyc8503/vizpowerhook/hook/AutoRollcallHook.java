            ...
            Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        NotificationUtils.showNotification(AndroidAppHelper.currentApplication().getApplicationContext(), "自动签到失败!", "请手动打开无限宝进行签到!并将此 BUG 连同 Xposed 框架日志反馈到 GitHub 项目的 Issues.");
